...
export function Conection({
  ...
  const [formData, setFormData] = useState<string[]>(['N/A', 'N/A', 'N/A', 'N/A', 'N/A'])
  ...
  return (
    <div className="flex flex-col  justify-center items-center gap-2 mt-12">
      <div className="flex flex-col  justify-evenly items-start gap-4">
          ...
          <div className="flex gap-4">
            ...
            <label className="flex items-center">
              <input
                ...
                onChange={() => {
                  const newFormData = 'auto' // Atualiza o valor para "auto"
                  setFormData([newFormData, 'null', 'null', 'null', '0000']) // Atualiza o estado com o novo array
                }}
                className="mr-2 peer h-4 w-4 border-gray-300 text-sky-500 focus:ring-sky-500"
              />
              Auto
        ...
        {isEnabled && (
          <>
            <InputField id="apn" label="APN" value={formData[1]} onChange={handleInputChange} />
            <InputField
              id="usuario"
              label="Usuario"
              value={formData[2]}
            ...
            />
            <InputField id="senha" label="Senha" value={formData[3]} onChange={handleInputChange} />
            <InputField id="pin" label="PIN" value={formData[4]} onChange={handleInputChange} />
          </>
        )}
      </div>
      <div className="flex justify-end mt-10 border-t-[1px] border-gray-200 pt-4 w-full gap-4">
        ...
        <Button
          onClick={() => handleSendSettingsConection && handleSendSettingsConection(formData)}
        >
